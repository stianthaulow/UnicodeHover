...
<body>
  ...
  {/* Raw text. */}
  <p lang="cs">
    Jako efektivnější se nám jeví pořádání tzv. Road Show prostřednictvím našich
    autorizovaných dealerů v Čechách a na Moravě, které proběhnou v průběhu září
    a října.
  </p>
  {/* Hex-escaped. */}
  <p lang="cs">
  ...
  <p lang="cs">
    ...
    po&rcaron;&aacute;d&aacute;n&iacute; tzv. Road Show
    prost&rcaron;ednictv&iacute;m na&scaron;ich autorizovan&yacute;ch
    dealer&uring; v &Ccaron;ech&aacute;ch a na Morav&ecaron;, kter&eacute;
    prob&ecaron;hnou v pr&uring;b&ecaron;hu z&aacute;&rcaron;&iacute; a
    &rcaron;&iacute;jna.
  </p>
  {/* Named entities with multiple code points. */}
  <p>
    &NotSquareSuperset;&NotRightTriangleBar;&NotEqualTilde;&NotGreaterFullEqual;&NotHumpDownHump;
    &fjlig;
  </p>
</body>;
